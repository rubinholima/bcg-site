...
export default function NovaSaidaMedicaPage() {
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <h1 className="text-2xl font-bold tracking-tight">Registrar saída</h1>
      </div>
      <Card>
        <CardHeader>
        ...
        <CardContent>
          <MedicalDepartureForm
            tenants={tenants}
            initialTenantId={searchParams.get("tenantId") ?? undefined}
            initialPlayerId={searchParams.get("playerId") ?? undefined}
            onSaved={(id) => router.push(`/dashboard/medico/saidas/${id}`)}
          />
        </CardContent>
      </Card>
    </div>
