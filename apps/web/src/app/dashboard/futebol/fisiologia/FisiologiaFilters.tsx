...
interface FisiologiaFiltersProps {
  players: PlayerOption[];
  selectedPlayerId: string;
  onSelectPlayer: (id: string) => void;
}

const FISIOLOGIA_BASE = "/dashboard/futebol/fisiologia";

export function FisiologiaFilters({
  players,
  selectedPlayerId,
  onSelectPlayer,
}: FisiologiaFiltersProps) {
  ...
  const applyFilters = useCallback(
    (updates?: { tenantId?: string; category?: string; search?: string }) => {
      ...
      router.push(`${FISIOLOGIA_BASE}?${params.toString()}`);
    },
