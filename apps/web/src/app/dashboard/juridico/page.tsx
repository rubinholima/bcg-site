...
import { ArrowLeft, Scale, UserCircle, ChevronRight } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Contratos e documentos por atleta
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Clique em um atleta para gerenciar contratos e documentos
          </CardDescription>
        </CardHeader>
        <CardContent>
          {loading ? (
                ...
                <TableBody>
                  {players.map((p) => (
                    <TableRow key={p.id}>
                      ...
                      <TableCell>
                        <Link href={`/dashboard/juridico/${p.id}`}>
