...
import { ArrowLeft, DollarSign, Settings, ExternalLink, CheckCircle, XCircle, Loader2 } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Departamento administrativo — integração com Omie para contas a receber e faturamento
          </p>
        </div>
      </div>

      {/* Base integração: Omie */}
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between flex-wrap gap-2">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <CardDescription>
                  Contas a receber, faturamento e finanças via ERP Omie. A configuração fica em Configurações → Integrações.
                </CardDescription>
              </div>
            </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Resumo financeiro, contas a receber e relatórios vindos do Omie serão exibidos aqui.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-muted-foreground text-sm">
            Após configurar a integração, esta tela poderá mostrar contas a receber, fluxo de caixa e dados de faturamento sincronizados com o Omie.
          </p>
        </CardContent>
      </Card>
    </div>
