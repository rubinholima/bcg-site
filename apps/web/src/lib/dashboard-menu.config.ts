...
export const PLAYER_TABS: PlayerTabConfig[] = [
  ...
  { id: "saidas_medicas", label: "Saídas médicas", icon: Stethoscope, moduleSlug: "saude" },
...
export const DASHBOARD_MENU: MenuItemConfig[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        slug: "saude_relatorios",
        label: "Relatórios",
        href: "/dashboard/relatorios/saude",
        icon: BarChart3,
        moduleSlug: "relatorios_saude",
        children: [
          {
            slug: "saude_rel_lista_atletas",
            label: "Lista de atletas",
          ...
          {
            slug: "saude_rel_fisio_atendimentos",
            label: "Fisioterapia — Atendimentos",
            href: "/dashboard/relatorios/saude/fisioterapia-atendimentos",
            icon: BarChart3,
            moduleSlug: "relatorios_saude",
          },
          {
            slug: "saude_rel_fisio_lesionados",
            label: "Fisioterapia — Lesionados",
            href: "/dashboard/relatorios/saude/fisioterapia-lesionados",
            icon: ClipboardList,
            moduleSlug: "relatorios_saude",
          },
          {
            slug: "saude_rel_fisio_carga",
            label: "Fisioterapia — Carga",
            href: "/dashboard/relatorios/saude/fisioterapia-carga",
            icon: Activity,
            moduleSlug: "relatorios_saude",
          },
          {
            slug: "saude_rel_enfermaria",
            label: "Enfermaria",
