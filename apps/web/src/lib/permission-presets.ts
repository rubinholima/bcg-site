...
export const PERMISSION_PRESETS: readonly PermissionPreset[] = [
  ...
  },
  {
    ...
    description: "Comissão, análise de vídeo, performance, captação, try-outs e logística — sem dados clínicos sensíveis.",
    grants: [
      { role: "comissao", slug: "futebol_comissao" },
      { role: "comissao", slug: "futebol_logistica" },
      { role: "comissao", slug: "futebol_analise" },
      { role: "comissao", slug: "futebol_analise_desempenho" },
      { role: "comissao", slug: "futebol_performance" },
      { role: "comissao", slug: "futebol_fisiologia" },
      { role: "comissao", slug: "futebol_preparacao_fisica" },
      { role: "comissao", slug: "adm_nutricao" },
      { role: "comissao", slug: "futebol_captacao" },
      { role: "comissao", slug: "futebol_tryouts" },
      { role: "comissao", slug: "futebol_treinadores" },
      { role: "editor", slug: "futebol_comissao" },
      { role: "editor", slug: "futebol_analise" },
      { role: "editor", slug: "futebol_analise_desempenho" },
      { role: "editor", slug: "futebol_performance" },
      { role: "editor", slug: "futebol_fisiologia" },
      { role: "editor", slug: "futebol_preparacao_fisica" },
      { role: "editor", slug: "adm_nutricao" },
      { role: "editor", slug: "futebol_captacao" },
      { role: "editor", slug: "futebol_tryouts" },
      { role: "editor", slug: "futebol_logistica" },
      { role: "editor", slug: "futebol_treinadores" },
      { role: "company_admin", slug: "futebol_comissao" },
      { role: "company_admin", slug: "futebol_analise" },
      { role: "company_admin", slug: "futebol_analise_desempenho" },
      { role: "company_admin", slug: "futebol_performance" },
      { role: "company_admin", slug: "futebol_fisiologia" },
      { role: "company_admin", slug: "futebol_preparacao_fisica" },
      { role: "company_admin", slug: "adm_nutricao" },
      { role: "company_admin", slug: "futebol_captacao" },
      { role: "company_admin", slug: "futebol_tryouts" },
      { role: "company_admin", slug: "futebol_logistica" },
      { role: "company_admin", slug: "futebol_treinadores" },
      { role: "analista", slug: "futebol_analise" },
      { role: "analista", slug: "futebol_analise_desempenho" },
      { role: "analista", slug: "futebol_performance" },
      { role: "analista", slug: "futebol_treinadores" },
    ],
  },
  {
