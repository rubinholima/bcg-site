...
export const MODULE_DISPLAY_NAMES: Record<string, string> = {
  ...
  futebol_analise: "An\u00E1lise / m\u00E9tricas de atletas",
  futebol_analise_desempenho: "An\u00E1lise e desempenho (v\u00EDdeo)",
  futebol_performance: "Performance",
  futebol_preparacao_fisica: "Prepara\u00E7\u00E3o f\u00EDsica",
  futebol_captacao: "Captação",
  futebol_tryouts: "Try-outs",
