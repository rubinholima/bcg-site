        ...
        <div className={containerClass}>
          ...
          {rows.length === 0 ? (
            ...
            <>
              ...
              >
                <table className={`w-full border-collapse text-left ${is3Col ? "min-w-0 table-fixed text-xs" : inSection ? "min-w-0 table-fixed" : "min-w-[800px]"} ${!is3Col && (inSection && (density === "minimal" || density === "compact") ? "text-xs" : "text-sm")}`}>
                  <thead>
                    <tr className={`text-zinc-400 ${is3Col ? "text-xs" : ""}`}>
                      <th className={`${is3Col ? "w-[4%] px-1 py-1.5 font-medium sm:px-1.5 sm:py-2" : inSection ? (density === "minimal" || density === "compact" ? "w-[4%] px-0.5 py-1 font-medium sm:py-1" : density === "large" ? "w-[4%] px-2 py-2.5 font-medium sm:px-3 sm:py-3" : "w-[4%] px-1 py-2 font-medium sm:px-2 sm:py-3") : "px-4 py-3 font-medium"} border-b border-white/10`}>{lang === "pt" ? "Pos" : "Pos"}</th>
                      <th className={`${is3Col ? "w-[22%] min-w-0 px-1 py-1.5 font-medium sm:px-1.5 sm:py-2" : inSection ? (density === "minimal" || density === "compact" ? "w-[22%] min-w-0 px-0.5 py-1 font-medium sm:py-1" : density === "large" ? "w-[22%] min-w-0 px-2 py-2.5 font-medium sm:px-3 sm:py-3" : "w-[22%] min-w-0 px-1 py-2 font-medium sm:px-2 sm:py-3") : "px-4 py-3 font-medium"} border-b border-white/10`}>{lang === "pt" ? "Time" : "Team"}</th>
                      <th className={`${is3Col ? "w-[4%] px-1 py-1.5 font-medium sm:px-1.5 sm:py-2" : inSection ? (density === "minimal" || density === "compact" ? "w-[4%] px-0.5 py-1 font-medium sm:py-1" : density === "large" ? "w-[4%] px-2 py-2.5 font-medium sm:px-3 sm:py-3" : "w-[4%] px-1 py-2 font-medium sm:px-2 sm:py-3") : "px-4 py-3 font-medium"} border-b border-white/10`}>{lang === "pt" ? "P" : "P"}</th>
                      <th className={`${is3Col ? "w-[3%] px-1 py-1.5 font-medium sm:px-1.5 sm:py-2" : inSection ? (density === "minimal" || density === "compact" ? "w-[3%] px-0.5 py-1 font-medium sm:py-1" : density === "large" ? "w-[3%] px-2 py-2.5 font-medium sm:px-3 sm:py-3" : "w-[3%] px-1 py-2 font-medium sm:px-2 sm:py-3") : "px-4 py-3 font-medium"} border-b border-white/10`}>{lang === "pt" ? "J" : "MP"}</th>
                      <th className={`${is3Col ? "w-[3%] px-1 py-1.5 font-medium sm:px-1.5 sm:py-2" : inSection ? (density === "minimal" || density === "compact" ? "w-[3%] px-0.5 py-1 font-medium sm:py-1" : density === "large" ? "w-[3%] px-2 py-2.5 font-medium sm:px-3 sm:py-3" : "w-[3%] px-1 py-2 font-medium sm:px-2 sm:py-3") : "px-4 py-3 font-medium"} border-b border-white/10`}>{lang === "pt" ? "V" : "W"}</th>
                      <th className={`${is3Col ? "w-[3%] px-1 py-1.5 font-medium sm:px-1.5 sm:py-2" : inSection ? (density === "minimal" || density === "compact" ? "w-[3%] px-0.5 py-1 font-medium sm:py-1" : density === "large" ? "w-[3%] px-2 py-2.5 font-medium sm:px-3 sm:py-3" : "w-[3%] px-1 py-2 font-medium sm:px-2 sm:py-3") : "px-4 py-3 font-medium"} border-b border-white/10`}>{lang === "pt" ? "E" : "D"}</th>
                      <th className={`${is3Col ? "w-[3%] px-1 py-1.5 font-medium sm:px-1.5 sm:py-2" : inSection ? (density === "minimal" || density === "compact" ? "w-[3%] px-0.5 py-1 font-medium sm:py-1" : density === "large" ? "w-[3%] px-2 py-2.5 font-medium sm:px-3 sm:py-3" : "w-[3%] px-1 py-2 font-medium sm:px-2 sm:py-3") : "px-4 py-3 font-medium"} border-b border-white/10`}>{lang === "pt" ? "D" : "L"}</th>
                      <th className={`${is3Col ? "w-[4%] px-1 py-1.5 font-medium sm:px-1.5 sm:py-2" : inSection ? (density === "minimal" || density === "compact" ? "w-[4%] px-0.5 py-1 font-medium sm:py-1" : density === "large" ? "w-[4%] px-2 py-2.5 font-medium sm:px-3 sm:py-3" : "w-[4%] px-1 py-2 font-medium sm:px-2 sm:py-3") : "px-4 py-3 font-medium"} border-b border-white/10`}>{lang === "pt" ? "GP" : "GF"}</th>
                      <th className={`${is3Col ? "w-[4%] px-1 py-1.5 font-medium sm:px-1.5 sm:py-2" : inSection ? (density === "minimal" || density === "compact" ? "w-[4%] px-0.5 py-1 font-medium sm:py-1" : density === "large" ? "w-[4%] px-2 py-2.5 font-medium sm:px-3 sm:py-3" : "w-[4%] px-1 py-2 font-medium sm:px-2 sm:py-3") : "px-4 py-3 font-medium"} border-b border-white/10`}>{lang === "pt" ? "GC" : "GA"}</th>
                      <th className={`${is3Col ? "w-[5%] px-1 py-1.5 font-medium sm:px-1.5 sm:py-2" : inSection ? (density === "minimal" || density === "compact" ? "w-[5%] px-0.5 py-1 font-medium sm:py-1" : density === "large" ? "w-[5%] px-2 py-2.5 font-medium sm:px-3 sm:py-3" : "w-[5%] px-1 py-2 font-medium sm:px-2 sm:py-3") : "px-4 py-3 font-medium"} border-b border-white/10`}>{lang === "pt" ? "SG" : "GD"}</th>
                      <th className={`${is3Col ? "w-[12%] px-1 py-1.5 font-medium sm:px-1.5 sm:py-2" : inSection ? (density === "minimal" || density === "compact" ? "w-[12%] px-0.5 py-1 font-medium sm:py-1" : density === "large" ? "w-[12%] px-2 py-2.5 font-medium sm:px-3 sm:py-3" : "w-[12%] px-1 py-2 font-medium sm:px-2 sm:py-3") : "px-4 py-3 font-medium"} border-b border-white/10`}>{lang === "pt" ? "Últ." : "Last"}</th>
                      <th className={`${is3Col ? "w-[14%] min-w-0 px-1 py-1.5 font-medium sm:px-1.5 sm:py-2" : inSection ? (density === "minimal" || density === "compact" ? "w-[14%] min-w-0 px-0.5 py-1 font-medium sm:py-1" : density === "large" ? "w-[14%] min-w-0 px-2 py-2.5 font-medium sm:px-3 sm:py-3" : "w-[14%] min-w-0 px-1 py-2 font-medium sm:px-2 sm:py-3") : "px-4 py-3 font-medium"} border-b border-white/10`}>{lang === "pt" ? "Próx." : "Next"}</th>
                    </tr>
                  </thead>
                  <tbody>
