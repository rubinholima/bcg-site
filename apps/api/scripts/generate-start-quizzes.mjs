/**
 * Gera quizzes substantivos a partir do conteúdo ensinado em cada player-data JSON.
...
const outPath = path.join(__dirname, 'start-content/generated-quizzes.json');
...
function buildQuestions(contentKey, player) {
  const isFinal = contentKey.includes('final-mission');
  ...
  // fallback from practice if not enough
