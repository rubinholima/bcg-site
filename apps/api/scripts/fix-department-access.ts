...
const ROLE_ALLOWED: Record<string, readonly string[]> = {
  ...
  estagiaria: [
    ...
    'saude/saude_cadastros__cad_estagiarios',
    'saude__psicologia',
    'saude/psicologia__psicologia_consultas',
    'saude/psicologia__psicologia_relatorios',
    'relatorios_saude',
  ],
  massagista: [
    'dashboard',
  ...
  coordenadora: [
    ...
    'saude__saude_visao',
    'saude',
    'saude/saude_cadastros__cad_psicologos',
    'saude/saude_cadastros__cad_estagiarios',
    'saude__psicologia',
    'saude/psicologia__psicologia_consultas',
    'saude/psicologia__psicologia_relatorios',
    'saude/psicologia__psicologia_material_apoio',
    'relatorios_saude',
  ],
  nutricionista: [
    'dashboard',
...
async function main() {
  ...
  console.log('\n2) Perfis ADM / Mkt / Saúde / Performance (whitelist)…');
  for (const role of [
    'compras',
    'financeiro',
    'rh',
