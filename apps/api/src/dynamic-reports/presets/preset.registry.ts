...
export const DYNAMIC_REPORT_POPULATIONS: DynamicReportPopulationDefinition[] = [
  ...
  },
  {
    ...
    source: 'player',
    filterKeys: ['search', 'category', 'situation', 'position', 'season', 'competition'],
  },
  {
...
export const DYNAMIC_REPORT_SORT_OPTIONS = [
  { key: 'fullName', label: 'Nome', populations: ['player.current_bid', 'player.loaned', 'player.athletes', 'people.cafeteria'] },
  { key: 'employeeFullName', label: 'Nome', populations: ['employee.active_staff', 'employee.by_department'] },
  { key: 'category', label: 'Categoria', populations: ['player.current_bid', 'player.loaned', 'player.athletes', 'people.cafeteria'] },
  { key: 'department', label: 'Departamento', populations: ['employee.active_staff', 'employee.by_department', 'people.cafeteria'] },
  { key: 'birthDate', label: 'Data de nascimento', populations: ['player.current_bid', 'player.loaned', 'player.athletes'] },
...
export const DYNAMIC_REPORT_GROUP_OPTIONS = [
  { key: 'none', label: 'Sem agrupamento', populations: ['player.current_bid', 'player.loaned', 'player.athletes', 'employee.active_staff', 'employee.by_department'] },
  { key: 'category', label: 'Por categoria', populations: ['player.current_bid', 'player.loaned', 'player.athletes'] },
